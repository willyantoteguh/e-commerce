...
class PaymentRouterImpl implements PaymentRouter {
  ...
  @override
  Future<dynamic>? navigateToPaymentMethod() async => await navigationHelper.pushNamed(
        AppRoutes.paymentMethod,
      );

  @override
  void selectPayment(PaymentMethodArgument argument) => navigationHelper.pop(argument);

  @override
  Future? navigateToPaymentVA(PaymentVAArgument argument) => navigationHelper.pushNamedAndRemoveUntil(AppRoutes.paymentVa, arguments: argument);

  @override
  void navigateToHome() => navigationHelper.pushNamedAndRemoveUntil(AppRoutes.home);
}
