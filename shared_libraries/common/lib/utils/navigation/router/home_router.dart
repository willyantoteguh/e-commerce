...
import '../argument/detail_product/detail_product_argument.dart';
...
class HomeRouterImpl implements HomeRouter {
  ...
  @override
  Future<dynamic>? navigateToEditProfile() => navigationHelper.pushNamed(AppRoutes.editProfile);

  @override
  void navigateToDetailProduct(DetailProductArgument argument) => navigationHelper.pushNamed(AppRoutes.detailProduct, arguments: argument);
