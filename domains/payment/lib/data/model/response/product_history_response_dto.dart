...
//   factory ProductHistoryResponseDto.fromJson(Map<String, dynamic> json) => ProductHistoryResponseDto(
//         status: json["status"],
//         code: json["code"],
...
class ProductHistoryResponseDto extends BaseResponse {
  ProductHistoryResponseDto({
    this.data,
  });
  ...
  factory ProductHistoryResponseDto.fromJson(Map<String, dynamic> json) {
    return ProductHistoryResponseDto()..data = HistoryDataDto.fromJson(json["data"]);
  }
}
...
class HistoryDataDto {
  ...
  factory HistoryDataDto.fromJson(Map<String, dynamic> json) => HistoryDataDto(
        ...
        data: List<DataHistoryDto>.from(json["data"].map((x) => DataHistoryDto.fromJson(x))),
      );
}
...
class DataHistoryDto {
  ...
  factory DataHistoryDto.fromJson(Map<String, dynamic> json) => DataHistoryDto(
        ...
        cartId: json["cart_id"],
        productData: List<ProductDataHistoryDto>.from(json["product_data"].map((x) => ProductDataHistoryDto.fromJson(x))),
        amount: json["amount"],
        statusTransaction: json["status_transaction"],
        paymentTransaction: PaymentTransactionHistoryDto.fromJson(json["payment_transaction"]),
...
class PaymentTransactionHistoryDto {
  ...
  factory PaymentTransactionHistoryDto.fromJson(Map<String, dynamic> json) => PaymentTransactionHistoryDto(
        method: json["method"],
...
class ProductDataHistoryDto {
  ...
  factory ProductDataHistoryDto.fromJson(Map<String, dynamic> json) => ProductDataHistoryDto(
...
class ProductHistoryDto {
  ...
  factory ProductHistoryDto.fromJson(Map<String, dynamic> json) => ProductHistoryDto(
        id: json["id"],
        name: json["name"],
        owner: json["owner"],
        stock: json["stock"],
...
class CategoryHistoryDto {
  ...
  factory CategoryHistoryDto.fromJson(Map<String, dynamic> json) => CategoryHistoryDto(
        id: json["id"],
        name: json["name"],
...
class UserInfoHistoryDto {
  ...
  factory UserInfoHistoryDto.fromJson(Map<String, dynamic> json) => UserInfoHistoryDto(
        id: json["id"],
        name: json["name"],
        city: json["city"],
      );
