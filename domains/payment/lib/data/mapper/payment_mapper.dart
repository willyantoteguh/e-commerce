...
import '../../domain/entity/response/product_history_entity.dart';
import '../model/response/product_history_response_dto.dart';
...
class PaymentMapper {
  ...
  List<PaymentDataEntity> mapListPaymentDataDtoToEntity(List<PaymentDataDto>? dto) {
    final payments = <PaymentDataEntity>[];

    for (PaymentDataDto e in dto!) {
      payments.add(_mapPaymentDataDtoToEntity(e));
    }
    return payments;
  }

  List<CreateTransactionDataEntity> mapListCreateTransactionDataDtoToEntity(List<CreateTransactionDataDto>? dto) {
  ...
  CreateTransactionDataEntity _mapCreateTransactionDataDtoToEntity(CreateTransactionDataDto dto) {
    return CreateTransactionDataEntity(
      ...
      paymentTransaction: _mapPaymentTransactionDtoToEntity(dto.paymentTransaction),
      createdAt: dto.createdAt ?? "",
      updatedAt: dto.updatedAt ?? "",
    );
  }

  PaymentTransactionEntity _mapPaymentTransactionDtoToEntity(PaymentTransactionDto dto) {
  ...
  CreatePaymentDataEntity mapCreatePaymentDataDtoToEntity(CreatePaymentDataDto? dto) {
  ...
  List<DataHistoryEntity> _mapListDataHistoryDtoToEntity(List<DataHistoryDto> dto) {
  ...
  DataHistoryEntity _mapDataHistoryDtoToEntity(DataHistoryDto dto) {
    return DataHistoryEntity(
      ...
      amount: dto.amount ?? 0,
      statusTransaction: dto.statusTransaction ?? "",
      paymentTransaction: _mapPaymentTransactionHistoryDtoToEntity(dto.paymentTransaction),
      createdAt: dto.createdAt ?? "",
      updatedAt: dto.updatedAt ?? "",
    );
  }

  PaymentTransactionHistoryEntity _mapPaymentTransactionHistoryDtoToEntity(PaymentTransactionHistoryDto dto) {
  ...
  List<ProductDataHistoryEntity> _mapListProductDataHistoryDtoToEntity(List<ProductDataHistoryDto> dto) {
  ...
  ProductDataHistoryEntity _mapProductDataHistoryDtoToEntity(ProductDataHistoryDto dto) {
