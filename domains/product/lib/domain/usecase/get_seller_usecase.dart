...
class GetSellerUseCase extends UseCase<SellerDataEntity, String> {
  ...
  GetSellerUseCase({required this.productRepository});

  @override
  Future<Either<FailureResponse, SellerDataEntity>> call(String params) async => await productRepository.getSeller(params);
}
