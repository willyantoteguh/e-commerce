...
class SaveProductUseCase extends UseCase<bool, ProductDetailDataEntity> {
  ...
  SaveProductUseCase({required this.productRepository});

  @override
  Future<Either<FailureResponse, bool>> call(ProductDetailDataEntity params) async => await productRepository.saveProduct(params);
}
