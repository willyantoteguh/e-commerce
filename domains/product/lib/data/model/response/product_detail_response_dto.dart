...
//   factory ProductDetailResponseDto.fromJson(Map<String, dynamic> json) => ProductDetailResponseDto(
//         status: json["status"],
//         code: json["code"],
...
class ProductDetailResponseDto extends BaseResponse {
  ProductDetailResponseDto({
    this.data,
  });

  ProductDetailDataDto? data;

  factory ProductDetailResponseDto.fromJson(Map<String, dynamic> json) {
    return ProductDetailResponseDto()..data = ProductDetailDataDto.fromJson(json["data"]);
  }
}
...
class ProductDetailDataDto {
  ...
  factory ProductDetailDataDto.fromJson(Map<String, dynamic> json) => ProductDetailDataDto(
        id: json["id"],
        name: json["name"],
...
class CategoryProductDetailDto {
  ...
  factory CategoryProductDetailDto.fromJson(Map<String, dynamic> json) => CategoryProductDetailDto(
        id: json["id"],
        name: json["name"],
...
class SellerDetailDto {
  ...
  factory SellerDetailDto.fromJson(Map<String, dynamic> json) => SellerDetailDto(
        id: json["id"],
        name: json["name"],
        city: json["city"],
      );
