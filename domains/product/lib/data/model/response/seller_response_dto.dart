...
//   factory SellerResponseDto.fromJson(Map<String, dynamic> json) => SellerResponseDto(
//         status: json["status"],
//         code: json["code"],
...
class SellerResponseDto extends BaseResponse {
  SellerResponseDto({
    this.data,
  });
  ...
  factory SellerResponseDto.fromJson(Map<String, dynamic> json) {
    return SellerResponseDto()..data = SellerDataDto.fromJson(json["data"]);
  }
}
