...
abstract class ProfileRepository {
  ...
  Future<Either<FailureResponse, UserEntity>> updateUserData({required UserRequestEntity userRequestEntity});
  Future<Either<FailureResponse, UserEntity>> uploadPhoto({required File image});
}
