...
//   factory ChartResponseDto.fromJson(Map<String, dynamic> json) => ChartResponseDto(
//         status: json["status"],
//         code: json["code"],
...
class ChartResponseDto extends BaseResponse {
  ChartResponseDto({
    this.data,
  });
  ...
  factory ChartResponseDto.fromJson(Map<String, dynamic> json) {
    return ChartResponseDto()..data = ChartDataDto.fromJson(json["data"]);
  }
}
...
class ChartDataDto {
  ...
  factory ChartDataDto.fromJson(Map<String, dynamic> json) => ChartDataDto(
        ...
        owner: json["owner"],
        amount: json["amount"],
        product: List<ProductsChartDto>.from(json["product"].map((x) => ProductsChartDto.fromJson(x))),
      );
}
...
class ProductsChartDto {
  ...
  factory ProductsChartDto.fromJson(Map<String, dynamic> json) => ProductsChartDto(
...
class ProductChartDto {
  ...
  factory ProductChartDto.fromJson(Map<String, dynamic> json) => ProductChartDto(
        id: json["id"],
        name: json["name"],
        owner: json["owner"],
        stock: json["stock"],
...
class CategoryChartDto {
  ...
  factory CategoryChartDto.fromJson(Map<String, dynamic> json) => CategoryChartDto(
        id: json["id"],
        name: json["name"],
...
class UserInfoChartDto {
  ...
  factory UserInfoChartDto.fromJson(Map<String, dynamic> json) => UserInfoChartDto(
        id: json["id"],
        name: json["name"],
        city: json["city"],
      );
