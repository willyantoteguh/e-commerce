...
class ProductCubit extends Cubit<ProductState> {
  ...
  ProductCubit({required this.getProductUseCase}) : super(ProductState(productState: ViewData.initial()));
  ...
  void getProduct() async {
    ...
    result.fold(
      (failure) => emit(
        ProductState(
          productState: ViewData.error(message: failure.errorMessage, failure: failure),
        ),
      ),
      (result) => emit(
        ProductState(
