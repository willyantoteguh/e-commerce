...
class UserCubit extends Cubit<UserState> {
  ...
  UserCubit({required this.getUserUseCase}) : super(UserState(userState: ViewData.initial()));
  ...
  void getUser() async {
    ...
    result.fold(
      (failure) => emit(
        UserState(
          userState: ViewData.error(message: failure.errorMessage, failure: failure),
        ),
      ),
      (result) => emit(
        UserState(
